...
export const tripSchema = z.object({
  ...
  dieselRate: z.coerce.number().min(0).default(100),
  mileage: z.coerce.number().min(0).default(6),
  fuelFilled: z.coerce.number().min(0).default(0),
  fuelRequired: z.coerce.number().optional(),
  fuelCost: z.coerce.number().optional(),
  acHours: z.coerce.number().min(0).default(0),
  acLitresPerHour: z.coerce.number().min(0).default(2),
  acStartTime: z.string().optional(),
  acEndTime: z.string().optional(),
  acPaidLt: z.coerce.number().min(0).default(0),
